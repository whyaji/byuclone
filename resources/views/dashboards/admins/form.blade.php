                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                ...
                                                <figure class="imagecheck-figure">
                                                    <img src="{{asset('img/examples/product1.jpg')}}" alt="title" class="imagecheck-image">
                                                </figure>
                                            </label>
                                        </div>
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                ...
                                                <figure class="imagecheck-figure">
                                                    <img src="{{asset('img/examples/product4.jpg')}}" alt="title" class="imagecheck-image">
                                                </figure>
                                            </label>
                                        </div>
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                ...
                                                <figure class="imagecheck-figure">
                                                    <img src="{{asset('img/examples/product3.jpg')}}" alt="title" class="imagecheck-image">
                                                </figure>
                                            </label>
                                        </div>
                                    </div>
