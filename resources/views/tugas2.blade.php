...
<body>
        ...
        <nav class="nav container">
            ...
            <div class="nav__menu" id="nav-menu">
                ...
                <ul class="nav__list">
                    ...
                    <li class="nav__item">
                        ...
                        <div class="sub__menu">
                            <ul class="sub__nav list__sub-menu sub__menu-app">
                                <li><a class="sub__menu-content" href="calculator.html">Calculator</a></li>
                                <li><a class="sub__menu-content" href="watchlist.html">Watch List</a></li>
                            </ul>
                        </div>
                    </li>
                    <div class="sub__menu-hide">
                        <ul class="sub__nav-menu list__sub-menu">
                            <li class="nav__item"><a class="nav__link sub__menu-content" href="calculator.html">Calculator</a></li>
                            <li class="nav__item"><a class="nav__link sub__menu-content" href="watchlist.html">Watch List</a></li>
                        </ul>
                    </div>
                    <li class="nav__item">
                        <a href="#" class="nav__link">
                    ...
                    <li class="nav__item">
                        <a href="author.html" class="nav__link">
                            <div class="nav__link-item">
                                Author
                            </div>
                        </a>
    ...
    <main class="main">
        <section class="container-list">
            <h1 style="text-align: center; margin-top:75px; color: blue">Tugas 2</h1>
            <h1 style="text-align: center">
                ...
                class ByU
                {
                    function pulsa()
                    {
                        echo "1. Buat 1 parent class yang berisikan 2 method ";
                        echo "<br>Ini Adalah Method 1 Pada Parent Class";
                    }
                    
                    function kuota()
                    {
                        echo "<br>Ini Adalah method 2 Pada Parent Class <br><br>";
                    }
                }
                ...
                abstract class KenapaByU
                {
                    abstract function alasan();
                    abstract function kataOrang();
                }

                // 3. Buat 1 child class yang mengextend abstract class yang telah dibuat 

                class JoinByU extends KenapaByU
                {
                    public function alasan()
                    {
                        echo "<br> 2 & 3. Buat 1 child class yang mengextend abstract class yang telah dibuat:";
                        echo "<br> Kuota gak dibagi-bagi, buat paket semaunya, semua lewat aplikasi";
                    }
                    
                    public function kataOrang()
                    {
                        echo "<br> Keren sh by.u🔥🔥🔥🔥 netizen minta apapun dibuatin😍, @renxxx <br><br>";
                    }
                }

                $abstract = new JoinByU();
                $abstract->alasan();
                $abstract->kataOrang();

                // 4. Buat trait untuk masing - masing abstract method yang telah dibuat tadi

                trait JoinByU_trait
                {
                    public function alasan()
                    {
                        echo "<br>4. Buat trait untuk masing - masing abstract method yang telah dibuat tadi";
                        echo "<br> Kuota gak dibagi-bagi, buat paket semaunya, semua lewat aplikasi";
                    }
                    public function kataOrang()
                    {
    ...
    <footer class="footer">
        <div class="footer__bg">
            <div class="footer__container container grid">
                <div>
                    <h1 class="footer__title">blog.U</h1>
                    <span class="footer__subtitle">by.U Digital Provider</span>
                </div>
                ...
                <ul class="footer__links">
                    ...
                    <li>
                        <a href="author.html" class="footer__link">Author</a>
                    </li>
                    <li>
                        <a href="" class="footer__link">Kenapa by.U</a>
                    </li>
                </ul>

                <div class="footer__socials">
                    <a href="https://www.facebook.com/people/Wahyu-Patriaji/100004943535789/" target="_blank" class="footer__social">
                        <i class="uil uil-facebook"></i>
                    </a>

                    <a href="https://www.instagram.com/wahyu.patriaji/" target="_blank" class="footer__social">
                        <i class="uil uil-instagram-alt"></i>
                    </a>

                    <a href="https://www.youtube.com/channel/UCyjAKZm56ipfKJ-GFEnCEjg" target="_blank" class="footer__social">
                        <i class="uil uil-youtube"></i>
                    </a>
                </div>
            </div>

            <p class="footer__copy">&#169; 2022 whyaji</p>
        </div>
    </footer>
