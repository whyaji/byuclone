...
<body>
    ...
    <!--==================== MAIN ====================-->
    <section class="section container-list-form">
        <div class="card-form">
            <h1 style="text-align: center;color: blue">Tugas 3</h1>
            <div class="card-header" style="background-color: #293023">
                <h1 style="text-align: center; color: white;">Hasil</h1>
            </div>
            <div class="card-body">
                <ul class="list-group">
                    <li><strong>Nama:</strong> <?= $_SESSION["nama"] ?></li>
                    <li><strong>NIM:</strong> <?= $_SESSION["nim"] ?></li>
                    <li><strong>No. Handphone:</strong> <?= $_SESSION["nohp"] ?></li>
                    <li><strong>Email:</strong> <?= $_SESSION["email"] ?></li>
                    <li><strong>Tanggal Lahir:</strong> <?= $_SESSION["ttl"] ?></li>
                    <li><strong>Jenis Kelamin:</strong> <?= $_SESSION["gender"] ?></li>
                    <li><strong>Hobi:</strong> <?php foreach ($_SESSION["Hobi"] as $hobi) : ?> <?= $hobi;
                                                                                                                    endforeach; ?></li>
                    <li><strong>Alamat:</strong> <?= $_SESSION["alamat"] ?></li>
                </ul>
                <a href="tugas3.php" type="button" class="btn-form btn-back" role="button">
                    <h2>Back</h2>
                </a>
            </div>
        </div>
